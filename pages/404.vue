    ...
    <CommonLayout>
      ...
      >
        <img
          ...
          class="w-[33.109] h-[22.073rem]"
          alt="not-found-img"
        />

        <div
          class="flex flex-col w-[33.938rem] items-center justify-center px-4 gap-4"
        >
          <p class="text-sm font-normal text-center">
            Sorry for the inconvenience. This page is currently unavailable!
          </p>
        </div>
      </div>
    </CommonLayout>
