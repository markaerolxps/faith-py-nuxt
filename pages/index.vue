<template>
    <div class="flex flex-col justify-center w-full">
        ...
        <div class="flex flex-col w-full h-full justify-center items-center py-20">
            <div class="main flex flex-col items-center gap-[3.5rem] w-[40rem]" v-if="step !== 'step-2'">
                <div class="flex flex-col items-center gap-[2rem]">
                    <h1 class="text-[#1C355E] text-center text-[3rem] font-bold leading-[3.5rem] ">Students Bureau of
                        Immigration Compliance</h1>

                    <span style="font-family: 'Roboto', sans-serif;"
                        class="text-black text-center text-sm font-normal px-16">Foreign National Students (FNS)
                        including
                        Dual Filipino Citizens (DFC) must comply with the Bureau
                        of Immigration’s requirements to be permitted to attend class at Faith Academy, Inc. Filipino
                        (having only one citizenship) students need only to submit a scanned copy of their Philippine
                        Statistics Authority (PSA) Certificate of Live Birth.</span>
                ...
                <div class="dual-citizen-no w-[33.563rem] flex flex-col items-start gap-[1rem]"
                    v-if="step === 'dual-citizen-no'">
                    <RegistrationForm @back-to-options="getStarted" />
                </div>
                <div class="dual-citizen-yes w-[33.563rem] flex flex-col items-start gap-[1rem]"
            ...
            <div class="step-2 flex flex-col items-center gap-[3.5rem] w-[40rem]" v-if="step === 'step-2'">
                ...
                <div class="flex flex-col items-center gap-[2rem] w-[33.563rem]">
                    <h1 style="font-family: 'Roboto', sans-serif;"
                        class="text-[#1C355E] text-center text-[3rem] font-bold leading-[3.5rem] ">Dual Citizen?
                    </h1>
